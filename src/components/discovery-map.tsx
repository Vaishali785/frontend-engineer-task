...
// TODO (done):  When zooming out, property nodes overlap and become cluttered.
...
import "leaflet.markercluster"; //for cluster type
...
import MarkerClusterGroup from "react-leaflet-cluster"; //to create marker cluster
